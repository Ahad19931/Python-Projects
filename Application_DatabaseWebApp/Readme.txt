The app allows the user to enter the height data after which the user receives an email on the entered email address containing the average height analysis.
